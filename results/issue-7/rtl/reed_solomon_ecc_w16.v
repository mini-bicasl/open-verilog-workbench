// Reed-Solomon ECC sub-module: 16-bit data width
// RS(6,2) over GF(2^8): N=6 bytes, K=2 data bytes, T=2 correctable errors
// Primitive polynomial: 0x11D, first-consecutive-root (FCR)=0
//
// Codeword layout (48 bits, little-endian byte):
//   [15:0]  – data bytes 0–1
//   [23:16] – parity byte 0
//   [31:24] – parity byte 1
//   [39:32] – parity byte 2
...
module reed_solomon_ecc_w16 (
    ...
    input  wire [15:0] data_in,       // 16-bit data word (2 GF symbols)
    input  wire [47:0] codeword_in,   // Received codeword for syndrome check / decode
    output reg  [47:0] codeword_out,  // Encoded codeword (data at LSB, parity at MSB)
    output reg  [15:0] data_out,      // Extracted data from codeword_in[15:0]
